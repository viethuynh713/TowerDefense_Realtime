...
namespace Game_Realtime.Service.AI.BehaviorTree.Bot.Spell
{
    public class CheckUseBurning: Node
    {
        ...
        public CheckUseBurning(ref BotBTData data, int energyRequired, string playerId, MonsterModel[] monsterList)
        {
            this.data = data;
        ...
        public override NodeState Evaluate()
        {
            ...
            // get the map tile which has most monster nearby and has at least 3 monsters whose HP is less than 30%
